...
import { ApproveTopicUseCase } from '@/2-application/use-cases/forum';
...
export async function POST(
  ...
  try {
    ...
    const useCase = new ApproveTopicUseCase(repository);
    ...
    return NextResponse.json({ message: 'Konu onaylandı' });
  } catch (error) {
    console.error('POST /api/forum/topics/[id]/approve error:', error);
