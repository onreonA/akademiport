...
const successStories: SuccessStory[] = [
  {
    ...
    summary: "Yerel üretimden küresel e-ticaret devi Amazon ve Alibaba'ya uzanan başarı hikayesi",
    beforeState:
  ...
  },
  {
    ...
    city: 'İzmir',
    logo: '/placeholder-logo.png',
    summary: 'SWOT analizi ile hedef pazar stratejisi değiştiren gıda firmasının Avrupa açılımı',
    beforeState:
  ...
  },
  {
    ...
    city: 'İstanbul',
    logo: '/placeholder-logo.png',
    summary: 'AI destekli içerik üretimi ile 10 kat hızlanan dijital pazarlama süreçleri',
    beforeState:
  ...
  },
  {
    ...
    city: 'Antalya',
    logo: '/placeholder-logo.png',
    summary: 'Doğal kozmetik markasının Avrupa ve Amerika pazarlarındaki hızlı yükselişi',
    beforeState:
...
export default function BasariHikayeleri() {
  ...
  const filteredStories = successStories.filter((story) => {
    const matchesFilter = activeFilter === 'Tümü' || story.sector === activeFilter;
    const matchesSearch =
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-to-br from-blue-50 via-purple-50 to-green-50 py-20 overflow-hidden">
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center bg-gradient-to-r from-green-100 to-blue-100 rounded-full px-8 py-3 mb-8">
            <Trophy className="text-green-600 mr-3 w-6 h-6" />
          ...
          <p className="text-xl lg:text-2xl text-gray-600 mb-12 max-w-4xl mx-auto leading-relaxed">
            Bu platformla e-ihracat yolculuğuna çıkan firmaların gerçek deneyimlerini ve başarı
            hikayelerini keşfedin. Her biri ilham verici, her biri gerçek.
          </p>
          <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
            ...
            >
              <Link href="#hikayeler">
                <ArrowDown className="mr-3 w-6 h-6" />
                Hikayeleri Keşfet
              </Link>
            </Button>
            <Button
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              <div className="text-4xl lg:text-5xl font-bold text-purple-600 mb-2">%300</div>
              <div className="text-gray-600 font-medium">Ortalama Büyüme</div>
            </div>
            <div className="text-center">
              <div className="text-4xl lg:text-5xl font-bold text-green-600 mb-2">75+</div>
              <div className="text-gray-600 font-medium">Hedef Ülke</div>
            </div>
            <div className="text-center">
              <div className="text-4xl lg:text-5xl font-bold text-orange-600 mb-2">₺2.5B</div>
      ...
      <section id="hikayeler" className="py-12 bg-white border-b border-gray-100">
                ...
                <div className="p-6 pb-0">
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex items-center space-x-4">
                      <div className="w-16 h-16 bg-gradient-to-br from-blue-500 to-purple-600 rounded-xl flex items-center justify-center border-2 border-gray-100">
                      ...
                      <div>
                        ...
                        <div className="flex items-center mt-1">
                          <MapPin className="text-gray-400 mr-1 w-4 h-4" />
                          <span className="text-gray-500 text-sm">{story.city}</span>
                        </div>
                      </div>
                    </div>
                    <div className="bg-green-100 rounded-full px-3 py-1">
                      <span className="text-green-700 font-bold text-sm">{story.growth}</span>
                    </div>
                  </div>
                </div>
                {/* Card Body */}
                <div className="px-6 pb-6">
                  <p className="text-gray-700 mb-6 leading-relaxed">{story.summary}</p>
                  {/* Tags */}
            ...
            <div className="space-y-8">
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-4 flex items-center">
                  <Building2 className="text-blue-600 mr-3 w-6 h-6" />
                  Firma Hakkında
                </h3>
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-4 flex items-center">
                  <Rocket className="text-purple-600 mr-3 w-6 h-6" />
              ...
              <div>
                ...
                <div className="bg-green-50 rounded-xl p-6 border-l-4 border-green-500">
                  <p className="text-gray-700 leading-relaxed mb-4">{selectedStory.results}</p>
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-4 flex items-center">
                  <CheckCircle2 className="text-indigo-600 mr-3 w-6 h-6" />
                  Danışman Görüşü
                </h3>
                <div className="bg-indigo-50 rounded-xl p-6 border-l-4 border-indigo-500 relative">
                  <span className="text-4xl text-indigo-300 absolute top-4 left-4">&ldquo;</span>
              ...
              <div>
                ...
                <div className="bg-blue-50 rounded-xl p-6 border-l-4 border-blue-500 relative">
                  <span className="text-4xl text-blue-300 absolute top-4 left-4">&ldquo;</span>
                  <p className="text-gray-700 leading-relaxed italic pl-12 mb-6">
                    {selectedStory.testimonial}
                  </p>
                  <div className="flex items-center">
                    <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full flex items-center justify-center mr-4 border-2 border-blue-200">
                      <span className="text-white font-bold">
                        {selectedStory.managerName.charAt(0)}
                      </span>
                    </div>
                    <div>
                      <p className="font-semibold text-gray-900">{selectedStory.managerName}</p>
                      <p className="text-blue-600 text-sm">{selectedStory.managerTitle}</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-4xl mx-auto text-white">
            <div className="inline-flex items-center bg-white/20 rounded-full px-6 py-3 mb-8">
              <Trophy className="text-white mr-3 w-6 h-6" />
            ...
            <p className="text-xl lg:text-2xl text-white/90 mb-12 leading-relaxed">
              Siz de bu başarı hikayelerinin bir parçası olmak istiyorsanız, hemen başvurunuzu yapın
              ve dönüşüm yolculuğunuza başlayın.
            </p>
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
                <div className="w-16 h-16 bg-white/20 rounded-2xl flex items-center justify-center mx-auto mb-4">
                  <FileText className="text-3xl text-white w-8 h-8" />
                </div>
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
                <div className="w-16 h-16 bg-white/20 rounded-2xl flex items-center justify-center mx-auto mb-4">
                  <Calendar className="text-3xl text-white w-8 h-8" />
                </div>
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
                <div className="w-16 h-16 bg-white/20 rounded-2xl flex items-center justify-center mx-auto mb-4">
                  <Rocket className="text-3xl text-white w-8 h-8" />
                </div>
                <h3 className="text-xl font-bold mb-2">3. Başarıya Ulaşın</h3>
                <p className="text-white/80 text-sm">12 aylık program ile hedeflerinize ulaşın</p>
              </div>
            </div>
