...
export default function ConsultantLeaderboardPage() {
  ...
  const fetchPrograms = async () => {
    try {
      ...
      if (data.success && data.data) {
        ...
        const fetchedPrograms = Array.isArray(data.data) ? data.data : [];
        setPrograms(fetchedPrograms);
        // Auto-select first program if available and no program is selected
    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="rankings" className="space-y-4">
        ...
        <TabsContent value="rankings" className="space-y-4">
          <LeaderboardTable programId={selectedProgramId || undefined} />
        </TabsContent>
