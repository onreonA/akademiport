...
export const CreateEcommerceMetricsDtoSchema = z
  .object({
    ...
    alibabaVisitorSectorAvg: z.number().int().min(0).default(0).optional(),
    ...
    alibabaMessageSectorAvg: z.number().int().min(0).default(0).optional(),
    alibabaSeriousBuyerCount: z.number().int().min(0).default(0).optional(),
