          ...
          <div className="grid lg:grid-cols-5 gap-8 mb-12">
            ...
            <div className="lg:col-span-2">
              <div className="mb-6">
                <div className="flex items-center mb-4">
                  ...
                  <span className="text-2xl font-bold text-white">Akademi Port</span>
                </div>
                <p className="text-gray-300 text-lg leading-relaxed mb-6">
                  Türkiye&apos;nin e-ihracat dönüşüm platformu. Küresel büyümenin kapılarını açıyor,
                  firmaları uluslararası pazarlarda başarıya ulaştırıyoruz.
                </p>
                {/* Stats */}
              ...
              <div>
                <h4 className="text-white font-semibold mb-4 flex items-center">
                  <span className="mr-2">Sosyal Medya</span>
                </h4>
                <div className="flex space-x-3">
                  ...
                  <a
                    href="#"
                    className="w-10 h-10 bg-gradient-to-br from-pink-500 to-red-500 rounded-lg flex items-center justify-center hover:scale-110 transition-transform duration-300"
                  >
                    <Instagram className="text-white w-5 h-5" />
                  </a>
                  <a
                    href="#"
                    className="w-10 h-10 bg-gradient-to-br from-red-500 to-red-600 rounded-lg flex items-center justify-center hover:scale-110 transition-transform duration-300"
                  >
                    <Youtube className="text-white w-5 h-5" />
                  </a>
                  <a
                    href="#"
                    className="w-10 h-10 bg-gradient-to-br from-blue-400 to-blue-500 rounded-lg flex items-center justify-center hover:scale-110 transition-transform duration-300"
                  >
            ...
            <div>
              <h3 className="text-white text-lg font-bold mb-6 flex items-center">
                <Rocket className="mr-2 w-5 h-5 text-blue-400" />
                Platform Hizmetleri
              </h3>
            ...
            <div>
              <h3 className="text-white text-lg font-bold mb-6 flex items-center">
                <HeadphonesIcon className="mr-2 w-5 h-5 text-purple-400" />
                Destek & Yardım
              </h3>
              <ul className="space-y-3">
                <li>
            ...
            <div>
              <h3 className="text-white text-lg font-bold mb-6 flex items-center">
                <ShieldCheck className="mr-2 w-5 h-5 text-green-400" />
                Yasal & Politikalar
              </h3>
              <ul className="space-y-3">
                <li>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h3 className="text-2xl font-bold text-white mb-2 flex items-center">
                  <Mail className="mr-3 w-6 h-6 text-blue-400" />
                  E-İhracat Güncellemeleri
                </h3>
                <p className="text-gray-300">
                  Yeni eğitimler, başarı hikayeleri ve özel fırsatlardan haberdar olun.
                </p>
              </div>
              <div>
                <div className="flex">
                  ...
                  />
                  <Button className="px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 rounded-r-xl rounded-l-none">
          ...
          <div className="border-t border-white/10 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              ...
              <div className="flex items-center space-x-4">
                <p className="text-gray-400">© 2025 Akademi Port. Tüm hakları saklıdır.</p>
                <div className="flex items-center space-x-2">
                  <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
                  <span className="text-green-400 text-sm font-medium">Güvenli Platform</span>
                </div>
              </div>
              {/* Additional Links */}
