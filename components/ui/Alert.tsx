...
export default function Alert({
  ...
  const typeConfig = {
    info: {
      ...
      leftAccent: 'bg-blue-50 text-blue-900 border-l-4 border-l-blue-500 border border-blue-200',
    ...
    success: {
      ...
      leftAccent: 'bg-green-50 text-green-900 border-l-4 border-l-green-500 border border-green-200',
    ...
    warning: {
      ...
      leftAccent: 'bg-yellow-50 text-yellow-900 border-l-4 border-l-yellow-500 border border-yellow-200',
    ...
    error: {
      ...
      leftAccent: 'bg-red-50 text-red-900 border-l-4 border-l-red-500 border border-red-200',
